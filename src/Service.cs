    ...
    namespace Spring
    {
        ...
        public class Service: ServiceBase
        {
            ...
            public Service ()
            {
                ...
                this.State.CurrentState = Spring.State.None;
            ...
            protected override void OnStart (string[] args)
            {
                ...
                this.State.CurrentState = Spring.State.Starting;
            ...
            protected override void OnContinue ()
            {
                ...
                this.State.CurrentState = Spring.State.Running;
                base.OnContinue ();
            }
            ...
            protected override void OnPause ()
            {
                ...
                this.State.CurrentState = Spring.State.Paused;
                base.OnPause ();
            }
            ...
            protected override void OnShutdown ()
            {
                ...
                this.State.CurrentState = Spring.State.ShuttingDown;
                base.OnShutdown ();
            }
